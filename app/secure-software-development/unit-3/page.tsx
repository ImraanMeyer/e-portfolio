                ...
                <div className="space-y-4 w-5/6" id="discussion">
                    ...
                    <div id="q2">
                        ...
                        <ul className="list-disc pl-6">
                            ...
                            <li className="text-md text-muted-foreground">
                                It permits dynamic code execution via eval() and exec(), which
                                can be exploited if used improperly.
                            </li>
                            <li className="text-md text-muted-foreground">
                    ...
                    <div className="q3">
                        ...
                        <p className="text-md text-muted-foreground mb-4">
                            ...
                            fewer memory management bugs—features that are desirable in secure
                            software development. However, for operating system (OS)
                        ...
                        <p className="text-md text-muted-foreground mb-4">
                            ...
                            critical for writing OS kernels and device drivers. Python, in
                            contrast, runs on an interpreter and requires a virtual machine or
                            an underlying OS to function, making it unsuitable as a
                            systems-level language.
                        </p>

                        <p className="text-md text-muted-foreground mb-4">
                            While research exists on writing OS components or scripting parts
                            in Python, it cannot replace C at the core OS level. The trade-off
                            is between safety and control—Python abstracts too much for the
                            low-level work needed in operating systems.
                        </p>

                        <p className="text-md text-muted-foreground mb-4">
                            While Python may improve developer productivity and reduce certain
                            vulnerabilities, it is not a better choice than C for OS
                            development due to its high-level nature and dependence on runtime
                            environments.
                        </p>
                    </div>
